...
class FrutaController {
    ...
    static updateFruta(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let objectId;
            try {
                objectId = frutas_service_1.default.validateId(id);
            }
            catch (error) {
                next(http_errors_1.default[400](error.message));
                return;
            ...
            try {
                ...
                if ((yield frutas.countDocuments({ _id: objectId })) === 0) {
                    next(http_errors_1.default[404]("A fruta com esse id não existe!"));
                    return;
                }
                try {
                    frutas_service_1.default.validade(fruta);
                ...
                yield frutas.updateOne({ _id: objectId }, { $set: fruta });
...
exports.default = FrutaController;
